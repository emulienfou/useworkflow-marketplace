# Contributing to WorkflowBuilder Marketplace

Thank you for your interest in contributing to the WorkflowBuilder Marketplace! We're excited to have you here and appreciate your help in expanding the plugin ecosystem for everyone.
...
There are many ways to contribute to the Marketplace:

- **Add integrations**: Expand the ecosystem with new service integrations
- **Report bugs**: Found something broken? Let us know!
- **Suggest features**: Have an idea for a plugin? We'd love to hear it
...
The Marketplace uses a **modular plugin-based system** organized by category. Each integration lives in its own directory with all its components self-contained.

### Quick Overview

Adding an integration requires:

1. Create a plugin directory inside the correct category under [`plugins/`](https://github.com/emulienfou/useworkflow-marketplace/tree/main/plugins)
2. Add a `README.md` at the root of your plugin
3. Run `pnpm discover-plugins` (auto-generates types)
4. Test your integration
5. Create a Pull Request

### Plugin Categories

Place your plugin inside the appropriate category folder:
...
Each plugin uses a **modular file structure** where every concern is self-contained:
...
```bash
mkdir -p plugins/<category>/my-integration/steps
```

#### Step 2: Create Icon Component

**File:** `plugins/<category>/my-integration/icon.tsx`
...
**File:** `plugins/<category>/my-integration/credentials.ts`
...
**File:** `plugins/<category>/my-integration/test.ts`
...
**File:** `plugins/<category>/my-integration/steps/send-message.ts`
...
**File:** `plugins/<category>/my-integration/index.ts`
...
**File:** `plugins/<category>/my-integration/README.md`

See the [README.md Requirement](#readmemd-requirement) section above for what to include.

#### Step 8: Run Plugin Discovery
...
- [ ] **README.md**: Plugin includes a clear, complete README
...
- ✅ Plugin is placed in the correct category folder
- ✅ You've tested your changes thoroughly

### PR Guidelines

1. **Clear title**: Use conventional commit format (e.g., `feat: add Stripe integration`)
2. **Detailed description**: Explain what your plugin does and why
3. **Screenshots**: Include for any UI elements
4. **Link issues**: Reference related issues (e.g., "Fixes #123")

### Review Process

All contributions go through a review process to ensure quality, security, and alignment with the project's goals. Our team reviews each submission focusing on:
...
1. Check existing integrations in [`plugins/`](https://github.com/emulienfou/useworkflow-marketplace/tree/main/plugins) for reference
2. Look at the template files in `plugins/_template/`
...
6. Open an [issue](https://github.com/emulienfou/useworkflow-marketplace/issues) on GitHub
...
1. Clone the [repository](https://github.com/emulienfou/useworkflow-marketplace)
2. Create plugin directory in the correct category under `plugins/` with these files:
   - `credentials.ts` - Credential type definition
...
3. Run `pnpm discover-plugins` to register the plugin
4. Test thoroughly
5. Create a Pull Request
...
Thank you for contributing to the WorkflowBuilder Marketplace! Your efforts help expand the ecosystem for everyone. 💙
