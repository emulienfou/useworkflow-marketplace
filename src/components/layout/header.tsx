...
export function Header() {
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between border-b bg-background/80 backdrop-blur-xl px-6 md:px-10 py-4">
      ...
      <div className="flex flex-1 justify-end gap-4 items-center">
        <div className="hidden lg:flex items-center relative">
          ...
          <div className="absolute right-2 flex gap-1">
            <kbd className="hidden sm:inline-flex items-center h-5 px-1.5 rounded border border-border bg-muted font-sans text-[10px] font-medium text-muted-foreground">
              ⌘K
            </kbd>
          </div>
        </div>
